...
# import os
# os.environ['DISPLAY'] = '192.168.31.240:5.0'
    ...
    while True:
        ...
        if hands:
            ...
            if fingerUpState == [1, 1, 1, 1, 1]:
                ...
                print(hands[0]['lmList'][0], hands[0]['lmList'][5])
